...
const SdgMeet = () => {
  return (
    <motion.div
      ...
      className='w-full max-w-[4000px] h-[120vh] mx-auto bg-[linear-gradient(0deg,#2D5D7C,#264D64,#336887)] flex flex-col gap-8 items-center justify-center md:gap-14 xl:gap-18 px-4 md:px-10 xl:px-24 py-8'
    >
