...
const Navbar = () => {
  ...
  placeholder-white placeholder:font-inter
    ...
    <Link className="w-[109px] h-[42px] rounded-[8px] text-white font-[inter] font-normal shadow-[0px_0px_10px_0px_#65C0ED80] text-[20px] bg-[linear-gradient(0deg,#165179,#2E5E7F,#5F8BA7)]" to="/signup">Sign Up</Link>
    </nav>
  )
}
